...
;; org mode
(defun asim/org ()
  (setq org-agenda-files (list "/Users/608481089/Work/AIB/aib.org"
															 "/Users/608481089/Work/AIB/Avaya/avaya.org"
															 "/Users/608481089/Work/AIB/UKB/ukb.org"))
  (setq org-todo-keywords
		'((sequence "TODO(t)" "WAITING(w)" "DOING(g)" "|" "DONE(d)" "CANCEL(c)")
		  (sequence "ISSUE(i)" "INVESTIGATE(v)" "|" "DONE(d)" "CANCEL(c)")
		  (sequence "CFT" "DEVELOPMENT" "CIT" "E2E" "DR" "|" "LIVE" "DEFERRED")
		  (sequence "RED(r)" "|" "GREEN(e)")))
